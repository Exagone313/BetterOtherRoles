...
namespace BetterOtherRoles.Patches {
    ...
    public static class VentUsePatch {
        public static bool Prefix(Vent __instance) {
            ...
            if (__instance.name.StartsWith("JackInTheBoxVent_")) {
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.PlayerControl.NetId, (byte)CustomRPC.UseUncheckedVent, Hazel.SendOption.Reliable, -1);
    ...
    class SurveillanceMinigamePatch {
        ...
        private static Sprite overlaySprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.NightVisionOverlay.png", 350f);
